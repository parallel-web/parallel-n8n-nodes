...
export async function execute(
	...
	const type = executeFunctions.getNodeParameter('monitorType', itemIndex, 'event_stream') as MonitorType;
	const taskRunId = executeFunctions.getNodeParameter('monitorTaskRunId', itemIndex, '') as string;
	const processor = executeFunctions.getNodeParameter('monitorProcessor', itemIndex, 'lite') as string;
